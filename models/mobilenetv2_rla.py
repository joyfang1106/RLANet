...
__all__ = ['RLA_MobileNetV2', 
           'rla_mobilenetv2', 'rla_mobilenetv2_eca', 
           'rla_mobilenetv2_k6', 'rla_mobilenetv2_k6_eca', 
           'rla_mobilenetv2_k12', 'rla_mobilenetv2_k12_eca', 
           'rla_mobilenetv2_k24', 'rla_mobilenetv2_k24_eca', 
           'rla_mobilenetv2_k32', 'rla_mobilenetv2_k32_eca'
           ]
...
def rla_mobilenetv2_eca(rla_channel=32, eca=True):
    """ Constructs a RLA_MobileNetV2 model.
    default: 
        rla_channel = 32, ECA=False
    """
...
def rla_mobilenetv2_k12_eca(eca=True):
    """ Constructs a RLA_MobileNetV2 model.
    default: 
        rla_channel = 32, ECA=False
    """
...
def rla_mobilenetv2_k24_eca(eca=True):
    """ Constructs a RLA_MobileNetV2 model.
    default: 
        rla_channel = 32, ECA=False
    """
...
def rla_mobilenetv2_k32_eca(eca=True):
    """ Constructs a RLA_MobileNetV2 model.
    default: 
        rla_channel = 32, ECA=False
    """
