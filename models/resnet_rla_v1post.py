'''
different RLA vairants v1, but post activation (default is pre-act)

## revise the last activation function before the FC layer: relu --> tanh
'''
...
__all__ = [
            'RLAv1p_ResNet', 'rlav1p_resnet50' # , # v1
