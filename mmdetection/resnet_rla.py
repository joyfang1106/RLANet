...
#                  norm_eval = False,
#                  style='pytorch',
#                  zero_init_last_bn=False, # zero_init_residual=False,
#                  groups=1, 
#                  width_per_group=64, 
#                  replace_stride_with_dilation=None,
#                  norm_layer=None):
#         super(RLA_ResNetH, self).__init__()
#         if norm_layer is None:
#             norm_layer = nn.BatchNorm2d
...
#         h = torch.zeros(batch, rla_channel, height, width, device='cuda')
...
#         # unused calculations for mmdetection
#         # h = self.bn2(h)
#         # h = self.relu(h)
...
#         freezed."""
#         super(RLA_ResNetH, self).train(mode)
#         self._freeze_stages()
